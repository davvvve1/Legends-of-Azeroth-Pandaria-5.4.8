            ...
            switch (spellInfo->Id)
            {
               ...
               case 42471: // Hatch Eggs
                ...
                case 116330: // Dizzying Haze
                    spellInfo->Effects[EFFECT_1].Mechanic = MECHANIC_NONE;
                    break;
                case 26134: // C'Thun / giant eye tentacle: Green Beam
                    // Keep the spreading mechanic, but prevent one clustered
                    // bot pull from escalating into a raid-wide chain wipe.
                    spellInfo->Effects[EFFECT_0].ChainTarget = 4;
                    spellInfo->Effects[EFFECT_0].DamageMultiplier = 1.25f;
                    break;
